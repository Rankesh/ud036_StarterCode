...
the_lego_movie = media.Movie(
                        "The Lego Movie",
                        ("An ordinary Lego minifigure who finds himself being"
                         "the only one to help a resistance stop a tyrannical"
                         "businessman from gluing everything in the Lego "
                         "worlds into his vision of perfection."),
